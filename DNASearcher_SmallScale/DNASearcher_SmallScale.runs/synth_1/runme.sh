...
HD_PWD='D:/SeniorDesign2/DNASearcher_SmallScale/DNASearcher_SmallScale.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DNASearcher.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DNASearcher.tcl
