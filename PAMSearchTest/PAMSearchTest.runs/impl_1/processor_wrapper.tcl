...
set rc [catch {
  ...
  add_files -quiet D:/SeniorDesign2/PAMSearchTest/PAMSearchTest.runs/synth_1/processor_wrapper.dcp
  ...
  set_param project.isImplRun true
  link_design -top processor_wrapper -part xc7a100tcsg324-1
  set_param project.isImplRun false
...
set rc [catch {
  ...
  catch { report_drc -file processor_wrapper_drc_routed.rpt -pb processor_wrapper_drc_routed.pb -rpx processor_wrapper_drc_routed.rpx }
  catch { report_methodology -file processor_wrapper_methodology_drc_routed.rpt -rpx processor_wrapper_methodology_drc_routed.rpx }
  catch { report_power -file processor_wrapper_power_routed.rpt -pb processor_wrapper_power_summary_routed.pb -rpx processor_wrapper_power_routed.rpx }
...
set rc [catch {
  ...
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
  catch { write_mem_info -force processor_wrapper.mmi }
  catch { write_bmm -force processor_wrapper_bd.bmm }
  write_bitstream -force processor_wrapper.bit 
  catch { write_sysdef -hwdef processor_wrapper.hwdef -bitfile processor_wrapper.bit -meminfo processor_wrapper.mmi -file processor_wrapper.sysdef }
  catch {write_debug_probes -no_partial_ltxfile -quiet -force debug_nets}
  catch {file copy -force debug_nets.ltx processor_wrapper.ltx}
