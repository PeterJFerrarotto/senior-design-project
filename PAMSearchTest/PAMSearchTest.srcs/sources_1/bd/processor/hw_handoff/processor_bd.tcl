...
CONFIG.PHASE {0.000} \
  ...
  # Create instance: PAMChunkSearch_0, and set properties
  set PAMChunkSearch_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:PAMChunkSearch:1.0 PAMChunkSearch_0 ]
...
CONFIG.RESET_BOARD_INTERFACE {reset} \
  ...
  # Create instance: offTargetSearcher_0, and set properties
  set offTargetSearcher_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:offTargetSearcher:1.0 offTargetSearcher_0 ]
...
CONFIG.USE_BOARD_FLOW {true} \
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M04_AXI [get_bd_intf_pins PAMChunkSearch_0/S00_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M05_AXI [get_bd_intf_pins microblaze_0_axi_periph/M05_AXI] [get_bd_intf_pins offTargetSearcher_0/S00_AXI]
  ...
  # Create port connections
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins axi_smc/aclk] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins mig_7series_0/sys_clk_i]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins PAMChunkSearch_0/s00_axi_aclk] [get_bd_pins PmodSD_0/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_smc/aclk1] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/M05_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins offTargetSearcher_0/s00_axi_aclk] [get_bd_pins rst_clk_wiz_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net mig_7series_0_ui_clk [get_bd_pins axi_smc/aclk2] [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins rst_mig_7series_0_81M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_clk_wiz_0_100M_peripheral_aresetn [get_bd_pins PAMChunkSearch_0/s00_axi_aresetn] [get_bd_pins PmodSD_0/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN] [get_bd_pins microblaze_0_axi_periph/M05_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins offTargetSearcher_0/s00_axi_aresetn] [get_bd_pins rst_clk_wiz_0_100M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A20000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs PAMChunkSearch_0/S00_AXI/S00_AXI_reg] SEG_PAMChunkSearch_0_S00_AXI_reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A30000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs offTargetSearcher_0/S00_AXI/S00_AXI_reg] SEG_offTargetSearcher_0_S00_AXI_reg
