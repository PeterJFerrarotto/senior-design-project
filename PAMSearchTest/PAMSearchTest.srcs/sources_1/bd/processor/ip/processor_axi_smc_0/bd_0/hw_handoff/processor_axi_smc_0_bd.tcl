...
################################################################
# This is a generated script based on design: bd_4f79
#
...
CONFIG.C_AUX_RST_WIDTH {1} \
  ...
  connect_bd_net -net psr_aclk_interconnect_aresetn [get_bd_pins swbd_aresetn] [get_bd_pins psr_aclk/interconnect_aresetn]
  connect_bd_net -net swbd_aclk_net [get_bd_pins aclk] [get_bd_pins swbd_aclk] [get_bd_pins psr_aclk/slowest_sync_clk]
