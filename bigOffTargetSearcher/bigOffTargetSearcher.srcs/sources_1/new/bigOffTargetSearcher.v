...
module offTargetSearcher #(
    parameter SEGMENT_SIZE = 4000,
    parameter BIG_SEQ_SIZE = 695208,
    parameter OUTER_LOCATION_NUM_SIZE = 20,
...
//    parameter PAM_SEQUENCE = 8'b00100010, //PAM Sequence - binary of GG
    parameter   IDLE = 8'b00000001,
                READ = 8'b00000010,
                INPUT = 8'b00000100,
                START_SEARCH = 8'b00001000,
                CHECK_CHUNK = 8'b00010000,
                HANDLE_CHUNK_RES = 8'b00100000,
                GET_CHUNK = 8'b01000000,
                COMPLETE = 8'b10000000
)
(
    input CLK,
    input RST,
    ...
    input [OUTER_LOCATION_NUM_SIZE - 1 : 0] offSet,
    input [11 : 0] size,
    input [SEGMENT_SIZE - 1 : 0] bigSeqSegment,
    ...
    task writeSegment;
        input [SEGMENT_SIZE - 1 : 0] segment;
        input [11 : 0] segmentSize;
        input [OUTER_LOCATION_NUM_SIZE - 1 : 0] offset;
        reg [11 : 0] i;
        begin
            for (i = offset; i < offset + segmentSize; i = i + 1)
            begin
            ...
            case (state)
                ...
                HANDLE_CHUNK_RES : begin
                    ...
                    if (matchFound == 1'b1) begin
                        if (pos == 15 || innerChunkPos == 15) begin
                            state <= COMPLETE;
                        end 
                        else begin
                            pos <= pos - 16;
